    ...
    <div class="hotels">
        <div class="hotels__block layout">
            ...
            <div class="hotels__items">
                ...
                <div class="hotels__item">
                    <a target="_blank" href="https://www.booking.com/hotel/bg/park-odessos-varna.uk.html" class="hotels__item-name">Park Hotel Odessos</a>
                    <div class="hotels__item-title">4 зірки, Золоті Піски</div>
                    <img class="hotels__item-img" src="/public/images/hotels/odessos.jpg">
                </div>
            ...
            <div class="faq__items">
                ...
                <div id="answer_4" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        ...
                        <p>- громадяни України старше 16 років - виключно з закордонним біометричним паспортом</p>
                        <p>- діти з 14 до 16 років - з ID-картою</p>
                        <p>- діти до 14 років -  по свідоцтву про народження</p>
                        ...
                        <p>- діти, які виїжджають з мамою, нотаріальне доручення від батька не потрібно</p>
                        <p>* Додатково дітей можна вписати в закордонний паспорт мами, якщо вона їде, в Державній міграційній службі України</p>
                        <p>!! На особистий розгляд працівника прикордонної служби можуть пропускати по внутрішніх паспортах осіб, що прописані в областях, де йдуть активні бойові дії.</p>
