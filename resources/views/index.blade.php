...
@section('content')
    ...
    <div class="main-screen">
        <div class="main-screen__block layout layout--small">
            ...
            <div class="main-screen__text">Безкоштовне проживання в готелі 4 зірки, біля моря, та триразове харчування</div>
            <a href="tel:+380972141648" class="main-screen__phone">+380972141648</a>
        </div>
    </div>
    ...
    <div class="about">
        <div class="about__block layout">
            ...
            <div class="about__text">Ми організовуємо проїзд, супровід до готелю, зустріч в Болгарії, допомогу з поселенням та під час перебування в Болгарії.
            </div>
            <div class="about__text">Хочемо, щоб ви почули нас. Наша задача - відповісти на всі питання, які вас
                хвилюють, допомогти в транспортуванні, поселенні та реєстрації і в подальшому освоїтись в умовах іншої
                держави.
            </div>
            <div class="about__text">Кожна людина має, окремо для себе, розглянути, вивчити всю інформацію та прийняти
                особисте рішення.
            </div>
        </div>
    </div>
    ...
    <div class="price">
        <div class="price__block layout">
            ...
            <div class="price__item">
                ...
                в Болгарії: <strong>70 евро + 950 гривень передоплата</strong>.
            </div>
        </div>
    </div>
        ...
        <div class="hotels__block layout">
            ...
            <div class="hotels__items">
                <div class="hotels__item">
                    <a target="_blank" href="https://www.booking.com/hotel/bg/mak.uk.html" class="hotels__item-name">Престиж Делюкс</a>
                    <div class="hotels__item-title">4 зірки, Золоті Піски</div>
                    <img class="hotels__item-img" src="/public/images/hotels/prestige.jpg">
                </div>

                <div class="hotels__item">
                    <a target="_blank" href="https://www.booking.com/hotel/bg/helios-spa-resort.uk.html" class="hotels__item-name">Хеліос Спа</a>
                    <div class="hotels__item-title">4 зірки, Золоті Піски</div>
                    <img class="hotels__item-img" src="/public/images/hotels/helios.jpg">
                </div>

                <div class="hotels__item">
                    <a target="_blank" href="https://www.booking.com/hotel/bg/royal-golden-sands.uk.html" class="hotels__item-name">Роял Парк</a>
                    <div class="hotels__item-title">4 зірки, Золоті Піски</div>
    ...
    <div class="faq">
        <div class="faq__block layout">
            ...
            <div class="faq__title">Відповіді на питання</div>
            ...
            <div class="faq__items">
                ...
                <div id="answer_3" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        ...
                        <p>950 грн це передоплата, яка оплачується відразу після реєстрації за формою (тільки після
                            цього за Вами закріплюються місця) та 70 євро вже на посадці в автобус, бажано в євро та без
                            здачі, пояснюємо чому. Саме тому що автобус замовлений в Болгарії і оплачували його потрібно
                            в євро. Якщо в когось долари, тоді це 80 дол. Якщо буде хтось, в кого гривні, тоді по
                ...
                <div id="answer_4" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        ...
                        <p>- діти, яким менше 16 років, та які виїжджають в супроводі третіх осіб (не одного з батьків), мають мати при собі нотаріальне доручення на виїзд</p>
                    </div>
                </div>
                <div id="answer_5" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>При приїзді в готель Вам необхідно буде підписати зобов’язання перебувати в готелі до 31 травня 2022 року. Ця умова є обов’язковою, але хочемо зазначити, що у Вас буде можливість залишити готель з поважних причин. Потрібно буде обов’язково попередити про дату виїзду представника готелю. І надалі він допоможе все коректно оформити.</p>
                    </div>
                </div>
                <div id="answer_6" class="faq__item">
                    <div class="faq__item-title">
                        <div class="faq__item-title-name">Я їду з маленькою дитиною, за неї теж необхідно оплачувати?</div>
                        <div class="faq__item-title-link"></div>
                        <div class="faq__item-title-copy"></div>
                    </div>
                    <div class="faq__item-answer">
                ...
                <div id="answer_7" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Якщо Ви приймаєте рішення скористатися цією програмою, Ви реєструєтесь за формою на сайті. Після чого Вам будуть надіслані реквізити для оплати. Тільки з передоплатою за Вами закріплюється місце.</p>
                    </div>
                </div>
                <div id="answer_8" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Після того, як необхідна кількість людей для автобусу буде набрана, я відправлю всі дані моїм колегам в Болгарію, вони розподілять всіх в готель і в номери. Після чого я Вам точно зможу сказати, в який саме готель ми їдемо. Хочу Вас заспокоїти, всі готелі зараз, це 4 зірки, є навіть 5 зірок.На даний момент розселяємо на курорті Золоті Піски. 17 км від нього знаходиться місто Варна, де Ви зможете знайти все необхідне (дитяче харчування, одяг тощо), по звичайним болгарським цінам. Там їздить звичайний автобус, тому дістатися проблем ніяких не буде. </p>
                    </div>
                </div>
                <div id="answer_9" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Важливо розуміти, що розселення буде по принципу «зайняти всі вільні місця», тому може бути варіант, що з вами буде хтось незнайомий. Двомісного розселення майже немає. Частіше 3-4-5, якщо 5 то це дві кімнати, в двомісних номерах зазвичай третє ліжко – це розкладний диван.</p>
                    </div>
                </div>
                <div id="answer_10" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>За 1-2 дні до дати виїзду Ви отримаєте інформацію про час і місце відправки автобусу з міст за маршрутом. </p>
                    </div>
                </div>
                <div id="answer_11" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Поїздка займає від 24 годин та залежить від самої ситуації на дорогах, від черг на кордоні та часу на реєстрацію. Тому ви маєте бути готові до того, що поїздка може зайняти 30-35 годин. </p>
                    </div>
                </div>
                <div id="answer_12" class="faq__item">
                    <div class="faq__item-title">
                        <div class="faq__item-title-name">Хто нас реєструє на отримання статуту «тимчасового захисту» і чи обов’язково це?</div>
                        <div class="faq__item-title-link"></div>
                        <div class="faq__item-title-copy"></div>
                    </div>
                    <div class="faq__item-answer">
                        <p>Головною умовою програми є – реєстрація на отримання тимчасової допомоги. Зареєструватись можливо на кордоні з Болгарією та вже на території Болгарії в спеціально відкритих пунктах. Де саме будемо реєструватися, будемо вирішувати по ситуації.</p>
                        <p>Ситуація в Болгарії з реєстрацією на «тимчасову допомогу», м’яко кажучи не дуже. Пункти реєстрації не справляються з кількістю людей, а готелі в свою чергу не можуть розселити без реєстрації. Саме тому один з найкращих і безпечних варіантів, це отримати реєстрацію на кордоні або в одному з перших міст на шляху до готелю. Але важливо розуміти, ця реєстрація, може зайняти 5 годин, а може і 10. І весь цей час доведеться чекати. Але це дуже важливо зробити відразу. Тому прошу, хто не готовий до подібних випробувань, краще не їхати.</p>
                    </div>
                </div>
                <div id="answer_13" class="faq__item">
                    <div class="faq__item-title">
                        <div class="faq__item-title-name">Автобус довозить тільки до кордону? Як дістатись до готелю? </div>
                        <div class="faq__item-title-link"></div>
                        <div class="faq__item-title-copy"></div>
                    </div>
                    <div class="faq__item-answer">
                        <p>Автобус довозить прямо в готель, там всім буде надана допомога при розселенні. Зберуться питання, в кого які є, і після якогось часу відпочинку, відповімо на всі хвилюючі питання.</p>
                    </div>
                </div>
                <div id="answer_14" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Ні, за програмою надається безоплатно проживання в готелях (саме з ними ми і домовляємось та направляємо туди людей з організованого рейсу), харчування в готелі. </p>
                        <p>Також за програмою «тимчасового захисту» надається соціальна допомога та невідкладна медична допомога. </p>
                    </div>
                </div>
                <div id="answer_15" class="faq__item">
                    ...
                    <div class="faq__item-answer">
                        <p>Не всі готелі готові приймати з тваринами, але ми постараємося найти варіанти для розміщення з тваринами (до 5 кг). Вам необхідно буде відразу про це попередити та зазначити в формі для реєстрації. </p>
                    </div>
                </div>
            </div>
        </div>
